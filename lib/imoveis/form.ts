...
import type { ImovelFormData, ImovelFormErrors } from './types'

export function defaultImovelFormData(): ImovelFormData {
  return {
    address: {
      postal_code: '',
      street: '',
...
export function validateImovelForm(data: ImovelFormData): ImovelFormErrors {
  const errors: ImovelFormErrors = {}
...
export function hasImovelFormErrors(errors: ImovelFormErrors): boolean {
