...
import { ProprietarioStepper } from '@/app/components/ProprietarioStepper/ProprietarioStepper'
...
export function CriarProprietarioWizard() {
  ...
  function goToStep(next: ProprietarioWizardStepId) {
    setStep(next)
    saveProprietarioWizardDraft({ step: next })
  }
