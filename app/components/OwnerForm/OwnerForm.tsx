...
import { bankOptions } from "@/lib/owners/banks";
import {
...
export function OwnerForm() {
  ...
  const [data, setData] = useState<OwnerFormData>(defaultOwnerFormData);
  ...
  function updatePhone(id: string, partial: Partial<OwnerFormData["phones"][0]>) {
    setData((prev) => ({
      ...prev,
        ...
        <div className="contract-create-form-grid">
          ...
          >
            <Select
              ...
              value={data.type}
              onChange={(e) => {
                const type = e.target.value as OwnerType;
                patch({
                  type,
              ...
              <div className="contract-create-form-grid">
                ...
                >
                  <MaskedTextInputBr
                    id={`tel-${tel.id}`}
                    mask="phone"
                    className={inputClass(Boolean(errors.phones?.[tel.id]?.number))}
                    value={tel.number}
      ...
      >
        <div className="entity-form-repeater">
          {data.bank_account.length === 0 ? (
            <p className="contract-create-field__hint" style={{ margin: 0 }}>
              ...
              <div className="contract-create-form-grid">
                  ...
                  <Select
                    ...
                    onChange={(e) =>
                      updateBankAccount(acc.id, {
                        type: e.target.value as OwnerBankAccount["type"],
                      })
                    }
                  />
                </EntityFormField>
                ...
                <EntityFormField label="Tipo PIX">
                  <Select
                    ...
                    onChange={(e) =>
                      updateBankAccount(acc.id, {
                        pix_type: e.target.value as OwnerBankAccount["pix_type"],
                      })
                    }
                  />
                </EntityFormField>
                ...
                <EntityFormField label="Conta principal" className="contract-create-field--wide">
                  <Checkbox
